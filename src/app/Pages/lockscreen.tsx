...
const Lockscreen: React.FC = () => {
  const [isMenuOpen, setIsMenuOpen] = useState<boolean>(false); // State for menu open/closed
  ...
  return (
    <>
      ...
      <div className="absolute left-0 top-0 h-screen w-full flex flex-col items-center z-10">
        <Login
          toggleLogin={function (): void {
            throw new Error("Function not implemented.");
          }}
        />
      </div>

      <Slider isMenuOpen={isMenuOpen} toggleMenu={toggleMenu} />
    </>
  );
};
